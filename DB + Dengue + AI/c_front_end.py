...
import importlib
b_backend = importlib.import_module("b_backend")
from b_backend import consulta

import streamlit as st
from streamlit_chat import message

st.title("App, Consultas Dengue + AI")
...
def click():
    if st.session_state.user != '':
        ...
        respuesta = consulta(pregunta)  # Llamada a la función consulta desde b_backend
